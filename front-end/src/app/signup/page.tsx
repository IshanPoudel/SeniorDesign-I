...
const Signup = () => {
    return (
        <div className="flex h-screen">
            <div className="flex-1 bg-cover bg-center dark:bg-gray-900 " style={{ backgroundImage: `url(${BackgroundImage.src})` }}> </div>
            <div className="flex-1 flex flex-col justify-center items-center bg-gray-100 dark:bg-gray-800">
                <h1 className="text-5xl font-extrabold mb-8 text-indigo-800 dark:text-indigo-400">Create an account</h1>
                <h2 className="text-2xl font-bold mb-8 text-indigo-800 dark:text-indigo-400">Ready for new adventures</h2>
